...
- :investspec:`ndr.ndr biophysical_table_path`
    ...
    .. note::
       ...
       If you provide *measured-runoff* values for loading, you do still need to provide *eff_n* or *eff_p* values in the biophysical table, as the retention efficiency values are also used to calculate the effective retention along the flow path.
